...
IOTIVITY_URL = "git://github.com/iotivity/iotivity.git"

SRCREV = "sandbox/pcoval/on/1.1-rel/jethro"
#SRCREV = "eff6a1df38e77d0d531078aa86823f4863fdac42"
#SRCREV = "f8a71dc6ee9920648dd799d519892fa04cd78eb7"
#SRCREV = "1.1.1"
IOTIVITY_URL = "git://github.com/tizenteam/iotivity.git;protocol=http;nobranch=1;destsuffix=${S}"

SRC_URI = "${IOTIVITY_URL} \
           https://github.com/01org/tinycbor/archive/${TINYCBOR_SRCREV}.zip;name=tinycbor;destsuffix=${S}  \
           http://pkgs.fedoraproject.org/repo/pkgs/gtest/gtest-1.7.0.zip/2d6ec8ccdf5c46b05ba54a9fd1d130d7/gtest-1.7.0.zip;name=gtest \
...
SRC_URI[tinycbor.sha256sum] = "b5b002f5540e44c995ee57c62604e85c32525b79fb720dceb422265e80aa9cba"
...
python () {
    ...
    EXTRA_OESCONS = "TARGET_OS=yocto TARGET_ARCH=" + IOTIVITY_TARGET_ARCH + " RELEASE=1 WITH_RD=1 ROUTING=GW VERBOSE=1"
