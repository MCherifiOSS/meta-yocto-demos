...
SRCREV = "a6ab3a35746c936230db6eacab839c17df75fedf"
...
SRC_URI = "git://github.com/tizenteam/iotivity.git;protocol=http;nobranch=1;destsuffix=${S} \
           ...
           https://github.com/google/googletest/archive/release-1.7.0.zip/gtest-1.7.0.zip;name=gtest;destsuffix=${S}/gtest-1.7.0 \
...
do_compile_prepend() {
    ...
    sed -e 's|Return|#TODO|g' -i  ${S}/build_common/SConscript

cat<<EOF>> ${S}/build_common/SConscript
